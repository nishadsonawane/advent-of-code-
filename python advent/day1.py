...
#importing the puzzle input

puzzle_input [two934seven1
8825eightknfv
sevenoneqbfzntsix55
...
#creating a function for calculating calibration
def calibration(line) :
    first_num = int(line[0])
    last_num = int(line[-1])

    #unable to find out the way to represent both the digits together 